<template>
  <div class="appointment-detail-page">
    ...
    <div v-else>
      <h1>Информация о записи пациента</h1>
      ...
      <div class="d-flex">
        <router-link to="/doctor/appointments" class="btn btn-secondary me-2">
...
export default {
  ...
  methods: {
    ...
    async fetchAppointment() {
      ...
      try {
        const response = await DoctorAppointmentService.getAppointment(this.$route.params.id)
    ...
    async cancelAppointment() {
      ...
      try {
        const response = await DoctorAppointmentService.cancelAppointment(this.appointment.appoid)
